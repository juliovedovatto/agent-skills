...
metadata:
  attribution:
    orwell: "Six rules from George Orwell's 1946 essay 'Politics and the English Language' (public domain)."
    asd-ste100: "Owned by ASD (Aerospace, Security and Defence Industries Association of Europe), Brussels. Copyright and trademark of ASD (EU Trade Mark No. 017966390). https://www.asd-ste100.org"
    builder-essential-skills: "Adapted from the orwell-writing skill in Builder's Essential Skills by Tam Nguyen (https://github.com/tamdogood/builder-essential-skills), MIT License, Copyright (c) 2026 Tam Nguyen."
  note: "This skill applies ASD-STE100 as a plain-English discipline; it does not reproduce the official specification or its controlled dictionary."
---
